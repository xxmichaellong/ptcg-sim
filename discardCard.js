...
export function discardCard(){
    ...
    if (selectedCard.location === 'hand'){
        ...
        // remove card from bench.cards array and add it to discard.cards array
        ...
        discard.images.push(...bench.images.splice(selectedCard.index, 1));

        // remove image from bench_html container
        bench_html.removeChild(discard.images[discard.count-1]);

        // append image to discard container
        discard_html.appendChild(discard.images[discard.count-1]);
