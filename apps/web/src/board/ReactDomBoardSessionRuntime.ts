...
export interface ReactDomBoardSessionRuntimeOptions {
...
/**
 * Opt-in vertical composition for the normalized React DOM board. It is not
 * imported by any production route. Upstream session/replay/presentation
 * ownership remains with the route runtime.
 */
export class ReactDomBoardSessionRuntime {
  ...
  constructor(private readonly options: ReactDomBoardSessionRuntimeOptions) {
    ...
    this.createRenderer = options.createRenderer ?? createReactDomBoardRenderer;
  }
