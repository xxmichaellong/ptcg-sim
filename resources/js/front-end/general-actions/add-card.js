...
export const addCard = (user, rawCardAttributes, rawImageAttributes, oppRawImageAttributes) => {
    const _card = new Card(rawCardAttributes, rawImageAttributes, oppRawImageAttributes);
    if (user === 'self'){
