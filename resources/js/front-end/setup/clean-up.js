...
export function cleanUp(user){
    ...
    if (user === 'self'){
        ...
        selfContainersDocument.querySelectorAll('.circle').forEach(element => element.parentNode.removeChild(element));
    } else {
        ...
        oppContainersDocument.querySelectorAll('.circle').forEach(element => element.parentNode.removeChild(element));
    };
