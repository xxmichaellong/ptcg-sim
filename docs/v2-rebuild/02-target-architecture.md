...
| Board                      | renderer-neutral contract; normalized keyed React DOM       | ADR-004 preserves native parity and avoids WebGL/CORS/overlay costs; ADR-015 owns the still-required physical performance proof |
