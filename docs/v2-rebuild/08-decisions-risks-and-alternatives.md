...
| ADR-015 | `PRODUCT_REQUIRED` | Ratify browser, viewport, reference hardware, and accessibility support windows.                                                                                                                      | Quantitative gates require named environments; ADR-022 separately resolves the v1 fallback/deprecation window.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
