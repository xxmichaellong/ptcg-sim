...
| ADR-019 | `ACCEPTED` | Project owner explicitly authorized direct MagicCircle implementation reuse on 2026-08-31; preserve provenance and any required notices.                                                              | Resolves the project-level copy blocker while retaining PTCG-owned contracts, tests, and license review. See `ADR-019-MAGICCIRCLE-REUSE.md`.                                                                                                                                                                                                                                                                             |
...
The 2026-09-14 closeout completed standalone records for every non-deferred
architecture decision. A future change must update its ADR, this register, and
affected requirements before implementation. See
`reviews/2026-09-14-adr-readiness-closeout.md`.
