...
| ADR-015 | `PRODUCT_REQUIRED` | Ratify browser, viewport, reference hardware, accessibility, and v1 fallback/deprecation windows.                                                                                                     | Quantitative gates require named environments, and retiring v1 requires an explicit observation window.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
2. Which known behavioral bugs may be corrected during parity work, and who signs
   each exception?
3. What is the v1 fallback/deprecation observation window?
