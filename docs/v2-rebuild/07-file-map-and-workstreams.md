...
download with object-URL revocation, and starts document full screen. Clear log
uses the route-owned presentation reset. No canonical-state serializer or file
import is implied. The later production split remains:
