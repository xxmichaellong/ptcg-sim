...
| native deck-builder listener/render/sync files        | `apps/web/src/features/deck/{LegacyDeckBuilderSession,LegacyDeckBuilderWorkspace,LegacyDeckImportPanel,popular-decklists}.*`, `apps/web/src/dev/LegacyDeckBuilderBrowserHarness.tsx`, `tests/browser/legacy-deck-builder-browser-parity.spec.ts` | React DOM with independent main/alternate state and the unchanged visible workflow. The exact 168-deck corpus from `sample.decklists.js` is provenance-pinned and dynamically imported only after book/wand use; the right panel holds imports in an editable Save/Cancel/Confirm review transaction. One unmounted session owner composes both surfaces, the acknowledged dirty-deck drain, unload guard, catalog, and prepared card-back callback. A direct-import-only Chromium harness now compares complete v1 and candidate controls, geometry, and paint and exercises arbitrary-image, acknowledged recovery, multiplayer denial, focus, inertness, and teardown. It exposed and closed the viewport-relative panel-padding, inline-control-gap, and Linux textarea-font differences. Production entry points still import none of this surface; route activation remains separate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
