...
tests/legacy-fixtures/renderer/{board-layout-v1,card-stack-layout-v1,contained-card-layout-v1}.json
tests/characterization/{legacy-board-layout,legacy-card-stack-layout,legacy-contained-card-layout}.test.ts
tests/browser/{legacy-dom-geometry,legacy-card-stack-geometry,legacy-contained-card-geometry}.spec.ts
