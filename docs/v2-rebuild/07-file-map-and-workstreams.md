...
| native deck-builder listener/render/sync files        | `apps/web/src/features/deck/{LegacyDeckBuilderWorkspace,LegacyDeckImportPanel,popular-decklists}.*`                                                                                           | React DOM with independent main/alternate state and the unchanged visible workflow. The exact 168-deck corpus from `sample.decklists.js` is provenance-pinned and dynamically imported only after book/wand use; the right panel holds imports in an editable Save/Cancel/Confirm review transaction and exposes the prepared card-back callback at the original location. Route/session composition remains separate.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
