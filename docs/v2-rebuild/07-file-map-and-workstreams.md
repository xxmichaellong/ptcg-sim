...
| legacy action arrays/version                          | `packages/legacy-import/src/*`, then versioned `src/v1/*` interpreters                                                                                                                        | The strict 1.5/1.5.1 envelope parser and exact 50-action allowlist are implemented without action execution. Add frozen positional schemas and deterministic interpreters incrementally; never import the live v1 runtime.                                                                                                            |
