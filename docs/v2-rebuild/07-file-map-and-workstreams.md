...
| sidebox import/export/replay handlers                 | `room-authority/{replay-history,projected-replay}.ts`, `client-session/{session,replay-playback}.ts`, `apps/web/src/{session,replay}/*`, `features/saves/*`, `features/replay/*` | Bounded delivery, playback, coordination, board guarding, headless chrome/control binding, and generation-safe effects are implemented; mounting the full sidebar plus save/export/continuation remains later work. |
