...
| Card movement         | `MoveCard`, `MoveCards`, `MoveZoneContents`, `MoveCardToDeckTop`, `SwapCardWithDeckTop`, `MovePrizesToDeckBottom` | Explicit source/target IDs and attachment policy.                                                                                                |
