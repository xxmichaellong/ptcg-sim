...
| Card movement         | `MoveCard`, `MoveCards`, `MoveZoneContents`, `MoveRelativeToDeckTop`, `SwapWithDeckTop` | Explicit source/target IDs and attachment policy.                                                                                                |
...
| Relationships         | `AttachCard`, `EvolveCard`, `RestoreStagedStack`, `ResolveStagedCards`                  | Departure, restoration, and bulk work-area resolution remain transactional.                                                                      |
