...
- A bounded authoritative replay ledger, session-bound streamed projected
  ...
  encrypted storage secrecy, and retry after source/save eviction in
...
| [Continuation preview runbook](../../apps/server/CONTINUATION_PREVIEW_RUNBOOK.md)                  | Private default-off bundle, phased activation, staged rotation/rollback, and evidence/teardown contract      |
