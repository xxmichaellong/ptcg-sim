...
const selfElements = zoneIds.map(zoneId => selfContainerDocument.getElementById(zoneId));
const oppElements = zoneIds.map(zoneId => oppContainerDocument.getElementById(zoneId));
